...
export default function Home() {
    ...
    settingsApi.get()
      .then(({ data }) => {
        if (data.settings) {
          ...
          if (data.settings.youtube_url) {
            setActiveVideo(getYoutubeEmbedUrl(data.settings.youtube_url));
          }
        }
      })
      .catch(console.error);
  ...
  const s = settings || {
    ...
    youtube_videos: 'https://www.youtube.com/embed/dQw4w9WgXcQ, https://www.youtube.com/embed/L_LUpnjgPso',
...
From building apps at MedMate, ERT, and Cigniti to mentoring 10,000+ students and guiding 100+ trainers at 10,000 Coders, my journey has been all about turning code into careers and learning into real-world capability.`,
  ...
  const handleContactSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await settingsApi.submitContact(contactForm);
  ...
  return (
    <div style={{ background: '#050508', minHeight: '100vh', color: '#f8fafc', fontFamily: 'Inter, sans-serif' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          {user ? (
            <Link to={user.role === 'admin' ? '/admin/dashboard' : '/dashboard'} className="btn btn-sm" style={{ background: '#e50914', color: '#fff', fontWeight: 700 }}>
            ...
            <>
              ...
              <Link to="/signup" className="btn btn-sm" style={{ background: '#e50914', color: '#fff', fontWeight: 700, borderRadius: '6px' }}>
                Join Community
              </Link>
            </>
          )}
      ...
      <main style={{ maxWidth: '1140px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        {/* Section 1: Hero Showcase (RAW TALKS Aesthetic) */}
        <section style={{
          display: 'grid',
          ...
          <div>
            ...
            {/* Social Stats Cards (Instagram & YouTube) */}
        ...
        {/* Section 2: What is Career With Chaithanya? */}
        ...
        {/* Section 3: Admin Configured YouTube Videos & Podcast Sessions */}
        {videoList.length > 0 && (
          <section style={{ padding: '36px 0 50px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {/* Horizontal Scroll Side-by-Side Compact Video Cards */}
            <div style={{
              display: 'flex',
              gap: '16px',
              overflowX: 'auto',
        ...
        {/* Section 4: Reviews Section (Our Viewers Are the Wordsmiths!) */}
        <section style={{
        ...
        {/* Section 5: Let's Collaborate (Contact Form - Matches Screenshot #2) */}
        <section style={{
          background: '#12121c',
          border: '1px solid rgba(255,255,255,0.08)',
          borderRadius: '20px',
      ...
      <footer style={{
        ...
        <div style={{ maxWidth: '1140px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            <strong style={{ color: '#fff' }}>CAREER WITH CHAITHANYA</strong> &mdash; Learn. Complete. Grow.
          </div>
          <div style={{ display: 'flex', gap: '16px' }}>
            <a href={s.linkedin_url} target="_blank" rel="noreferrer" style={{ color: '#0a66c2', display: 'flex', alignItems: 'center', gap: 4 }}>
              <Linkedin size={14} /> LinkedIn
            </a>
            <a href={s.instagram_url} target="_blank" rel="noreferrer" style={{ color: '#dc2743', display: 'flex', alignItems: 'center', gap: 4 }}>
