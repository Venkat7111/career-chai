...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            else if (user.status === 'PENDING') router.push('/pending');
            ...
            <div className="auth-card">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input id="login-email" className="form-input" type="email" name="email" placeholder="you@example.com" value={form.email} onChange={handleChange} required autoComplete="email" />
                    </div>
                    <div className="form-group">
                        <label className="form-label" htmlFor="login-password">Password</label>
                        <div style={{ position: 'relative' }}>
                            <input id="login-password" className="form-input" type={showPwd ? 'text' : 'password'} name="password" placeholder="Enter your password" value={form.password} onChange={handleChange} required style={{ paddingRight: 42 }} />
