    ...
    <div className="animate-fade">
      ...
      <div className="grid-2" style={{ marginBottom: 28 }}>
        ...
        <div className="card">
          <div className="section-header">
            ...
            <Link href="/todos" className="btn btn-ghost btn-sm">View All</Link>
          </div>
          {(todos?.total || 0) === 0 ? (
            <div className="empty-state" style={{ padding: '30px 20px' }}>
            ...
            <div style={{ fontSize: '0.875rem' }}>
              ...
              <Link href="/todos" className="btn btn-secondary w-full" style={{ marginTop: 16, justifyContent: 'center' }}>
                Manage To-Dos →
              </Link>
            </div>
          )}
      ...
      <div className="card">
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <Link href="/tasks" className="btn btn-primary">Browse Available Tasks</Link>
          <Link href="/my-tasks" className="btn btn-secondary">My Task Board</Link>
          <Link href="/todos" className="btn btn-secondary">My To-Do List</Link>
          <Link href="/results" className="btn btn-secondary">View Submissions</Link>
        </div>
      </div>
    </div>
  );
